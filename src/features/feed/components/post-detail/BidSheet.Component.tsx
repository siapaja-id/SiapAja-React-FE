  ...
  <AnimatePresence>
    {isOpen && (
      <motion.div 
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="absolute inset-0 z-[70] bg-black/80 backdrop-blur-sm flex flex-col justify-end border-x border-outline-variant"
      >
        ...
        >
          ...
          <div className="space-y-5 mb-6">
            <div className="flex items-center justify-between bg-surface-container border border-outline-variant rounded-[28px] p-2 shadow-inner">
              <button 
                onClick={() => onBidAmountChange(Math.max(1, bidAmount - 5))}
                className="w-16 h-16 flex items-center justify-center rounded-[20px] bg-on-surface/5 hover:bg-red-500/20 hover:text-red-400 text-on-surface-variant transition-all active:scale-95"
              >
                <Minus size={28} />
              </button>
              ...
              <button 
                ...
                className="w-16 h-16 flex items-center justify-center rounded-[20px] bg-on-surface/5 hover:bg-emerald-500/20 hover:text-emerald-400 text-on-surface-variant transition-all active:scale-95"
              >
                <Plus size={28} />
              </button>
            </div>
            ...
            <div className="flex justify-center gap-2">
              ...
              <button onClick={() => onBidAmountChange(defaultBid)} className="px-4 py-2 rounded-xl bg-on-surface/5 hover:bg-on-surface/10 text-on-surface text-xs font-bold transition-colors">Match Original</button>
            ...
            <textarea 
              ...
              className="w-full bg-on-surface/5 border border-outline-variant rounded-2xl p-4 text-sm text-on-surface placeholder:text-on-surface-variant/30 min-h-[100px] resize-none focus:outline-none focus:border-primary/50 transition-colors"
            />
          </div>
